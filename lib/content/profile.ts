export const profile = {
  ...
  avatar: "/avatar.jpg",
  hero: {
    heading: ["Amirhosein", "Arabhaji"],
    bio: "I work on the parts of a product you never see: data models, query paths, cache boundaries, permission rules. I like problems where the answer can be measured, and I would rather remove a layer than add one.",
  },
  about: {
    quote: "I would rather understand a system than memorise a framework.",
    paragraphs: [
